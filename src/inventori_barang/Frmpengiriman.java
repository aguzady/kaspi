...
public class Frmpengiriman extends javax.swing.JDialog {
    ...
    public Frmpengiriman(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        initUI();
        ...
        SelectPelanggan();
        TxtEmpty();
        view_provinsi process = new view_provinsi();
        try {
            process.execute();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void initComponents() {
        ...
        jCkodepos = new javax.swing.JComboBox();
        jCkelurahan = new javax.swing.JComboBox();

        setDefaultCloseOperation(javax.swing.WindowConstants.DISPOSE_ON_CLOSE);
        setTitle("Inventori Barang :: Transaksi Pengiriman");
        ...
        jCprovinsi.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "- - Pilih Provinsi - -" }));
        jCprovinsi.setToolTipText("");
        ...
        jCkota.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "    - - Pilih Kota - -" }));
        ...
        jCkecamatan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "     - - Pilih Kecamatan - -" }));

        jCkodepos.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "     - - Kode Pos - -" }));

        jCkelurahan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "     - - Pilih Kelurahan - -" }));
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(jCkecamatan, 0, 154, Short.MAX_VALUE)
                                    .addComponent(jCprovinsi, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(jCkota, 0, 154, Short.MAX_VALUE)
                                    .addComponent(jCkelurahan, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jCkodepos, javax.swing.GroupLayout.PREFERRED_SIZE, 154, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        ...
                        .addComponent(jCkota, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(jCkodepos, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
        ...
        String alamat ;
        alamat =(String)jCprovinsi.getSelectedItem()+", "+(String)jCkota.getSelectedItem()+", "+(String)jCkecamatan.getSelectedItem()+", "+(String)jCkelurahan.getSelectedItem()+", "+(String)jCkodepos.getSelectedItem();
        ...
        if(rowCount > 0 && !"".equals(row_tgl) && !"".equals(row_idpelanggan) && !"".equals(row_idpetugas)){
            ...
            try {
                Connection conn = konek.openkoneksi();
                java.sql.Statement stm = conn.createStatement();
                stm.executeUpdate("INSERT INTO trbarang_keluar(tgl, id_petugas, id_pelanggan, alamat) VALUES ('" + row_tgl + "', '" + row_idpetugas + "', '" + row_idpelanggan + "', '" + alamat + "')");
                konek.closekoneksi();
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "Error " + e);
            } catch (ClassNotFoundException ex) {
    ...
    private void jCprovinsiActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jCprovinsiActionPerformed
        ...
        view_kota process1 = new view_kota();
        try {
            process1.execute();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Frmpengiriman.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            Frmpengiriman dialog = new Frmpengiriman(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JComboBox jCkodepos;
